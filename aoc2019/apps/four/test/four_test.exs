defmodule FourTest do
  ...
  test "112232-112234 has 1 possible passwords" do
    assert Four.get_amount_of_possible_passwords_extra_criteria("112232-112234") == 1
  end

  test "123443-123445 has 0 possible passwords" do
    assert Four.get_amount_of_possible_passwords_extra_criteria("123443-123445") == 0
  end

  test "111121-111123 has 1 possible passwords" do
    assert Four.get_amount_of_possible_passwords_extra_criteria("111121-111123") == 1
  end

  test "357253-892942 has - possible passwords" do
    assert Four.get_amount_of_possible_passwords_extra_criteria("357253-892942") == 324
  end
